...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			code_1 = element("code");
    			t3 = text(/*code*/ ctx[0]);
    			add_location(div, file$2, 8, 1, 162);
    			attr_dev(h2, "class", "cata-name svelte-30e4r7");
    			add_location(h2, file$2, 9, 1, 209);
    			attr_dev(code_1, "class", "language-javascript language-js");
    			add_location(code_1, file$2, 10, 1, 244);
    			attr_dev(pre, "class", "code-popup svelte-30e4r7");
    			add_location(pre, file$2, 7, 0, 136);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", window.Prism.highlightAll(), false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let { code } = $$props, { name } = $$props;
    	console.log(window.Prism);
    	const writable_props = ["code", "name"];
    ...
    class Code extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { code: 0, name: 1 });
    		...
    		if (/*code*/ ctx[0] === undefined && !("code" in props)) {
    			console_1.warn("<Code> was created without expected prop 'code'");
    		}

    		if (/*name*/ ctx[1] === undefined && !("name" in props)) {
    			console_1.warn("<Code> was created without expected prop 'name'");
    		}
    	}
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 30, 4, 669);
    			add_location(p, file$3, 31, 4, 698);
    			attr_dev(div1, "class", "card svelte-asp8v1");
    			add_location(div1, file$3, 28, 0, 571);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
function declareWinner(fighter1, fighter2, firstAttacker) {
  ...
  return f1 < f2 ? fighter2.name : (f2 < f1 ? fighter1.name : firstAttacker)
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$8, 6, 0, 111);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Modal, Header, Gallery });
    	return [];
    }
